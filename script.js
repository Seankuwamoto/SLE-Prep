const workToAuthor = JSON.parse('{"Sir Gawain and the Green Knight":["Anonymous"],"Troubadour Poetry":["Jaufré Rudel","Bernart De Ventadorn","La Comtessa de Dia"],"Inferno":["Dante Alighieri"],"You Dreamed of Empires":["Enrigue"],"Letters From Mexico":["Hernan Cortez"],"Of Cannibals":["Montaigne"],"The Master\'s Tools Will Never Dismantle the Master\'s House":["Audrey Lorde"],"The Prince":["Machiavelli"],"Discourses":["Machiavelli"],"Renaissance Poetry":["Jacopo da Lentini","Dante Alighieri","Francesco Petrarca","Pietro Bembo","Gaspara Stampa","Michelangelo Buonarroti","Louise Labé","Edmund Spencer","William Shakespeare"],"The Tempest":["William Shakespeare"],"Royal Commentaries of the Incas":["Inca Garcilaso de la Vega"],"Don Quixote":["Cervantes"],"Meditations on First Philosophy":["René Descartes"],"Second Treatise on Government":["John Locke"],"Notes on the State of Virginia":["Thomas Jefferson"],"What is Enlightenment?":["Immanuel Kant"],"Discourse on Inequality":["Rousseau"],"Zong!":["M. NourbeSe Philip"],"Frankenstein":["Mary Shelley"],"On the Essence of Religion":["Schleiermacher"],"Auguries of Innocence":["Blake"],"The Book of Thel":["Blake"],"The Marriage of Heaven and Hell":["Blake"],"The Garden of Love":["Blake"],"A Poison Tree":["Blake"],"Letter to Dr. Tusler":["Blake"],"Preface to Lyrical Ballads":["William Wordsworth"],"Nutting":["William Wordsworth"],"Ode: Intimations of Immortality from Recollections of Early Childhood":["William Wordsworth"],"We Are Seven":["William Wordsworth"],"The Green Knight (Film)":["David Lowery"],"The Passion of Joan of Arc":["Carl Theodor Dreyer"],"Aguirre, The Wrath of God":["Werner Herzog"],"Cat\'s Cradle":["Stan Brakhage"],"Dog Star Man":["Stan Brakhage"],"Mothlight":["Stan Brakhage"]}');

const authorToWork = JSON.parse('{"Anonymous":["Sir Gawain and the Green Knight"],"Jaufré Rudel":["Troubadour Poetry"],"Bernart De Ventadorn":["Troubadour Poetry"],"La Comtessa de Dia":["Troubadour Poetry"],"Enrigue":["You Dreamed of Empires"],"Hernan Cortez":["Letters From Mexico"],"Montaigne":["Of Cannibals"],"Audrey Lorde":["The Master\'s Tools Will Never Dismantle the Master\'s House"],"Machiavelli":["The Prince","Discourses"],"Jacopo da Lentini":["Renaissance Poetry"],"Dante Alighieri":["Renaissance Poetry","Inferno"],"Francesco Petrarca":["Renaissance Poetry"],"Pietro Bembo":["Renaissance Poetry"],"Gaspara Stampa":["Renaissance Poetry"],"Michelangelo Buonarroti":["Renaissance Poetry"],"Louise Labé":["Renaissance Poetry"],"Edmund Spencer":["Renaissance Poetry"],"William Shakespeare":["Renaissance Poetry","The Tempest"],"Inca Garcilaso de la Vega":["Royal Commentaries of the Incas"],"Cervantes":["Don Quixote"],"René Descartes":["Meditations on First Philosophy"],"John Locke":["Second Treatise on Government"],"Thomas Jefferson":["Notes on the State of Virginia"],"Immanuel Kant":["What is Enlightenment?"],"Rousseau":["Discourse on Inequality"],"M. NourbeSe Philip":["Zong!"],"Mary Shelley":["Frankenstein"],"Schleiermacher":["On the Essence of Religion"],"Blake":["Auguries of Innocence","The Book of Thel","The Marriage of Heaven and Hell","The Garden of Love","A Poison Tree","Letter to Dr. Tusler"],"William Wordsworth":["Preface to Lyrical Ballads","Nutting","Ode: Intimations of Immortality from Recollections of Early Childhood","We Are Seven"],"David Lowery":["The Green Knight (Film)"],"Carl Theodor Dreyer":["The Passion of Joan of Arc"],"Werner Herzog":["Aguirre, The Wrath of God"],"Stan Brakhage":["Cat\'s Cradle","Dog Star Man","Mothlight"]}');
